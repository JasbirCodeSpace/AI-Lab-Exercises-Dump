...
# # store the feature matrix (X) and response vector (y); We can manually divide the dataset into determinant and predictor features.
# X = iris.data
# y = iris.target
 
# # splitting X and y into training and testing sets; here training size=70% and test size=30%
# X_train, X_test, y_train, y_test = train_test_split(
#     X, y, test_size=0.3, random_state=1)
 
# # training the model on training set
# gnb = GaussianNB()
# # gnb = MultinomialNB() # by using MultinomialNB, the accuracy has been reduced to 67%
